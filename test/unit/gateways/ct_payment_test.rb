...
class CtPaymentTest < Test::Unit::TestCase
  ...
  def test_failed_purchase
    @gateway.expects(:ssl_post).twice.returns(failed_purchase_response, successful_ack_response)
  ...
  def test_failed_authorize
    @gateway.expects(:ssl_post).twice.returns(failed_authorize_response, successful_ack_response)
  ...
  def test_failed_capture
    @gateway.expects(:ssl_post).twice.returns(failed_capture_response, successful_ack_response)
  ...
  def test_failed_refund
    @gateway.expects(:ssl_post).twice.returns(failed_refund_response, successful_ack_response)
  ...
  def test_successful_void
    @gateway.expects(:ssl_post).twice.returns(successful_void_response, successful_ack_response)
  ...
  def test_failed_void
    @gateway.expects(:ssl_post).twice.returns(failed_void_response, successful_ack_response)
  ...
  def test_failed_verify
    @gateway.expects(:ssl_post).twice.returns(failed_verify_response, successful_ack_response)
  ...
  def post_scrubbed
    %q(
      ...
      SSL established
      <- "POST /v1/purchase HTTP/1.1\r\nContent-Type: application/x-www-form-urlencoded\r\nConnection: close\r\nAccept-Encoding: gzip;q=1.0,deflate;q=0.6,identity;q=0.3\r\nAccept: */*\r\nUser-Agent: Ruby\r\nHost: test.ctpaiement.ca\r\nContent-Length: 528\r\n\r\n"
      <- "auth-api-key=[FILTERED]&payload="
      -> "HTTP/1.1 200 200\r\n"
      -> "Date: Fri, 29 Jun 2018 18:21:07 GMT\r\n"
      -> "Server: Apache\r\n"
      -> "Strict-Transport-Security: max-age=31536000; includeSubDomains; preload\r\n"
      ...
      SSL established
      <- "POST /v1/ack HTTP/1.1\r\nContent-Type: application/x-www-form-urlencoded\r\nConnection: close\r\nAccept-Encoding: gzip;q=1.0,deflate;q=0.6,identity;q=0.3\r\nAccept: */*\r\nUser-Agent: Ruby\r\nHost: test.ctpaiement.ca\r\nContent-Length: 156\r\n\r\n"
      <- "auth-api-key=[FILTERED]&payload=VHJhbnNhY3Rpb25OdW1iZXI9MDAwMDA3NzA5MDM3JkNvbXBhbnlOdW1iZXI9MDA1ODkmTWVyY2hhbnROdW1iZXI9NTM0MDAwMzA="
      -> "HTTP/1.1 200 200\r\n"
      -> "Date: Fri, 29 Jun 2018 18:21:08 GMT\r\n"
      -> "Server: Apache\r\n"
      -> "Strict-Transport-Security: max-age=31536000; includeSubDomains; preload\r\n"
